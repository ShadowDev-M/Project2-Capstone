...
SceneP0::SceneP0() : drawInWireMode{ false } {
	Debug::Info("Created SceneP0: ", __FILE__, __LINE__);
}

SceneP0::~SceneP0() {
	Debug::Info("Deleted SceneP0: ", __FILE__, __LINE__);
}

bool SceneP0::OnCreate() {
	Debug::Info("Loading assets SceneP0: ", __FILE__, __LINE__);
...
void SceneP0::OnDestroy() {
	Debug::Info("Deleting assets SceneP0: ", __FILE__, __LINE__);
...
void SceneP0::HandleEvents(const SDL_Event& sdlEvent) {
...
void SceneP0::Update(const float deltaTime) {
